...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--backbone", default="dinov2_vits14_reg",
                        choices=["dinov2_vits14", "dinov2_vits14_reg", "efficientnet_v2_s",
                                 "resnet50", "convnext_tiny", "convnext_small"])
    # ── 추천 파라미터로 기본값 업데이트 (v0.05) ──────────────────────────────
